...
uint64_t slide = _dyld_get_image_vmaddr_slide(1);

uint64_t getOf(uint64_t address) {
    return slide + address;
}
 
#define getRealOffset(x) getOf(x)

#define INIT_F(x,y) *(void **) (&x) = (void*) (y);





const void* *(*il2cpp_domain_assembly_open)(void* domain, const void * name);
void *(*il2cpp_domain_get)();
// const void *(*il2cpp_domain_assembly_open) (const char* name);
const void *(*il2cpp_assembly_get_image)(const void *assembly);
const void *(*il2cpp_class_from_name)(const void *image, const char *namespaze, const char *name);
const void *(*il2cpp_class_get_method_from_name)(const void *klass, const char *name, int argsCount);
void *(*il2cpp_class_get_field_from_name)(const void *klass, const char *name);
...
void *Il2CppGetMethodOffset(void*klass, const char *name) {
    ...
    //NSLog(@"s");
    while(void **method = (void**) il2cpp_class_get_methods(klass, &iter)) {
        const char *fname = il2cpp_method_get_name(method);
        if(!strcmp(fname, name)) {

            NSLog(@"%s adr %p offset %p",name, *method, (uintptr_t)*method - _dyld_get_image_vmaddr_slide(1));
            return *method;
        }

        // NSLog(@"method: %s", fname);
    }
    //NSLog(@"Cannot find function %s in class %s!", name, clazz);
    return 0;
}

void *(*kshifuifhihfp)(); //Camera_get_main
void *(*oidfodiofddf)(void *component);
void (*jiifjei8999dd)(void *transform, Vector3 *out);
size_t name_of, pawn_of, enemy_info_of, head_bone_of, AttackableInfo_of, max_health_of;

Matrix4x4 (*dfjd8dfhjdfjd)(void* camera);

Matrix4x4 (*dsoifpif888999fdk)(void* camera);

void* (*jigjdis4jkrsds)();

bool (*kgjdkgfgd99)(void * info);

bool (*fkdfmkd5655kk)(void * info);

float (*adsdsdbjfh6y6y)(void * pawn);
...
INIT_F(il2cpp_domain_assembly_open, getRealOffset(0x10740164C))
INIT_F(il2cpp_assembly_get_image, getRealOffset(0x1074517A4))
INIT_F(il2cpp_class_from_name, getRealOffset(0x107462140))
INIT_F(il2cpp_class_get_method_from_name, getRealOffset(0x107452E28))
INIT_F(il2cpp_domain_get, getRealOffset(0x10745B378))
INIT_F(il2cpp_class_get_field_from_name, getRealOffset(0x1074529F4))
INIT_F(il2cpp_field_static_get_value, getRealOffset(0x10745D3B4))
INIT_F(il2cpp_class_get_methods, getRealOffset(0x107452C80))
INIT_F(il2cpp_method_get_name, getRealOffset(0x107482970))

INIT_F(kshifuifhihfp, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"UnityEngine")),"UnityEngine", "Camera"), "get_main"));

INIT_F(oidfodiofddf, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"UnityEngine")),"UnityEngine", "Component"), "get_transform"));

INIT_F(jiifjei8999dd, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"UnityEngine")),"UnityEngine", "Transform"), "INTERNAL_get_position"));


void *name_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameEngine", "PlayerInfo"), "m_NickName");
name_of = *(size_t *)((uintptr_t) name_fld + 0x18);


void *pawn_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameBase", "BaseGame"), "EnemyPawns");
pawn_of = *(size_t *)((uintptr_t) pawn_fld + 0x18);


void *enemy_info_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameBase", "Pawn"), "m_PlayerInfo");
enemy_info_of = *(size_t *)((uintptr_t) enemy_info_fld + 0x18);

void *head_bone_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameBase", "Pawn"), "m_HeadBone");
head_bone_of = *(size_t *)((uintptr_t) head_bone_fld + 0x18);

void *AttackableInfo_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameEngine", "AttackableTarget"), "m_AttackableInfo");
AttackableInfo_of = *(size_t *)((uintptr_t) AttackableInfo_fld + 0x18);

void *max_health_fld = il2cpp_class_get_field_from_name(il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")), "GameEngine", "AttackableTargetInfo"), "m_MaxHealth");
max_health_of = *(size_t *)((uintptr_t) max_health_fld + 0x18);


INIT_F(dfjd8dfhjdfjd, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"UnityEngine")),"UnityEngine", "Camera"), "get_worldToCameraMatrix"))

INIT_F(dsoifpif888999fdk, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"UnityEngine")),"UnityEngine", "Camera"), "get_projectionMatrix"))

INIT_F(jigjdis4jkrsds, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")),"GameEngine", "GamePlay"), "get_Game"))

INIT_F(kgjdkgfgd99, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")),"GameBase", "Pawn"), "get_isAlive"))

INIT_F(fkdfmkd5655kk, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")),"GameEngine", "PlayerInfo"), "get_isRobot"))

INIT_F(adsdsdbjfh6y6y, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")),"GameBase", "Pawn"), "get_Health"))

INIT_F(get_localPawn, (uintptr_t)Il2CppGetMethodOffset((void*)il2cpp_class_from_name(il2cpp_assembly_get_image(il2cpp_domain_assembly_open(il2cpp_domain_get(),"Assembly-CSharp")),"GameEngine", "GamePlay"), "get_LocalPawn"))
...
// void (*fdjdkfd8difhdj)(void *transform, Vector3 *out) = (void (*)(void *, Vector3 *))getRealOffset(0x105118110); //Transform_INTERNAL_get_localPosition
...
NSString * ffoo6o6o6666666(float distance, void* m_EnemyInfo) //getNameEnemy
{
    ...
    _monoString * m_NickName = *(_monoString **)((uint64_t)m_EnemyInfo + name_of);
...
-(void)loadView
{
    ...
    noScreenShotView = [[HeeeNoScreenShotView alloc] initWithFrame:[UIApplication sharedApplication].windows[0].rootViewController.view.bounds];
...
-(void)viewDidLoad
{
    ...
    self.window = [[UIWindow alloc] initWithFrame:[UIApplication sharedApplication].windows[0].rootViewController.view.bounds];
...
-(void)drawInMTKView:(MTKView*)view
{
   ...
   if (MenDeal == true)
    {
        ImGui::Begin(make_string("Lavochka CODM").c_str(), &MenDeal, ImGuiWindowFlags_AlwaysAutoResize);
        ...
        ImGui::Separator();
        ImGui::Spacing();
        ImGui::Text(make_string("t.me/lavo_ios CODM Cheat Menu\n%.3f ms/frame (%.1f FPS)").c_str(), 60.0f / ImGui::GetIO().Framerate, ImGui::GetIO().Framerate);
        ImGui::End();
    }
    ...
    if(CheatState::show_esp){
        if (*jigjdis4jkrsds) {
            ...
            if(game != nullptr) {
                ...
                monoList<void **> *EnemyPawns = *(monoList<void **>**)((uint64_t)game + pawn_of);
                if(EnemyPawns != nullptr) {
                    int enemyCount = EnemyPawns->getSize();
                    for (int i = 0; i < enemyCount; i++){
                        void* m_EnemyInfo = *(void **)((uint64_t)EnemyPawns->getItems()[i] + enemy_info_of);
                        ...
                        if(m_EnemyInfo != nullptr) {
                            ...
                            void* m_headBone = *(void **)((uint64_t)EnemyPawns->getItems()[i] + head_bone_of);
                            if(m_headBone!=nullptr) {
                                ...
                                if(true && facing){
                                    ...
                                    if(CheatState::show_espinfo && shouldShow && isLive) {
                                        ...
                                        DrawText2(_espFont, 12, ImVec2(enemyHeadPositionScreen.X - (nicknameWidth.x/2.0f),enemyHeadPositionScreen.Y-16), ImColor(255,255,255), [nickname UTF8String], ImColor(0,0,0,190));
                                        float health = 0.0f;
                                        float maxHealth = 0.0f;
                                        if(*adsdsdbjfh6y6y != nullptr){
                                            health = adsdsdbjfh6y6y(EnemyPawns->getItems()[i]);
                                        }                            
                                        void* m_AttackableInfo = *(void **)((uint64_t)EnemyPawns->getItems()[i] + AttackableInfo_of);
                                        maxHealth = *(float *)((uint64_t)m_AttackableInfo + max_health_of);
    ...
    [renderEncoder pushDebugGroup:@"Dear ImGui rendering Lavochka"];
